...
class devModeWidget(QWidget):
    ...
    def create_widget(self):
        ...
        self.open_pipezer_user_button = QPushButton()
        self.open_pipezer_user_button.setObjectName("open_pipezer_user_button")
        self.open_pipezer_user_button.setFocusPolicy(Qt.NoFocus)
        self.open_pipezer_user_button.setMaximumSize(QSize(150, 50))
        self.open_pipezer_user_button.setMinimumSize(QSize(50, 50))
        self.open_pipezer_user_button.setText("open .pipezer")
    ...
    def create_layout(self):
        ...
        self._main_layout.addWidget(self.open_pipezer_user_button)

        

    def create_connections(self):
        self.prefs_button.clicked.connect(self.set_pref)
        self.open_pipezer_user_button.clicked.connect(self.open_pipezer_user)

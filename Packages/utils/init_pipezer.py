...
PREF_SOURCE_PATH = os.path.join(ROOT_PATH, '.pipezer')
USER_DIR = os.path.expanduser("~")
PREFS = os.path.join(USER_DIR, '.pipezer')
...
def update_houdini_prefs():
    ...
    radial_menu_file = 'pipezer.radialmenu'
...
def update_maya_prefs():
    ...
    SHELF_FILE = 'shelf_PipeZer.mel'
    MARKING_MENU_FILE = 'menu_pipezerMenu.mel'
    USER_SETUP_FILE = 'userSetup.py'

    MAYA_SHELF_PATH = os.path.join(USER_DIR, 'Documents', 'maya', '2024', 'prefs', 'shelves')
    MAYA_MENU_PATH = os.path.join(USER_DIR, 'Documents', 'maya', '2024', 'prefs', 'markingMenus')
    ...
    # shelf
    if os.path.exists(os.path.join(MAYA_SHELF_PATH, 'shelf_PipeZer.mel')):
        os.remove(os.path.join(MAYA_SHELF_PATH, 'shelf_PipeZer.mel'))
    shutil.copy(MAYA_SHELF_SOURCE_PATH, MAYA_SHELF_PATH)

    # marking menu
    if os.path.exists(os.path.join(MAYA_MENU_PATH, 'menu_pipezerMenu.mel')):
        os.remove(os.path.join(MAYA_MENU_PATH, 'menu_pipezerMenu.mel'))
    shutil.copy(MAYA_MENU_SOURCE_PATH, MAYA_MENU_PATH)

    #
    MAYA_ICON_DEST_PATH = os.path.join(USER_DIR, 'Documents', 'maya', '2024', 'prefs', 'icons')
    files = (
        'pipezer_icon.png',
        'publish_icon.png',
        'save_as_icon.png',

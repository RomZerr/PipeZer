...
from PySide2.QtWidgets import QDialog, QSizePolicy, QListWidget, QPushButton, QMenu, QGridLayout, QAbstractItemView, QAction
...
from Packages.utils.constants.constants_old import PIPEZER_ICON_PATH, ICON_PATH
...
class CreateSoftProjectDialog(QDialog):
    def __init__(self, parent = None, directory: str = None):
        ...
        self.setWindowIcon(QIcon(PIPEZER_ICON_PATH))
